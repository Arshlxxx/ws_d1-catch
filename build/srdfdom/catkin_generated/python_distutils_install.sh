...
echo_and_run cd "/home/nvidia/ws_d1/src/srdfdom"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/nvidia/ws_d1/src/srdfdom/setup.py" \
    egg_info --egg-base /home/nvidia/ws_d1/build/srdfdom \
    build --build-base "/home/nvidia/ws_d1/build/srdfdom" \
    install \
    --root="${DESTDIR-/}" \
